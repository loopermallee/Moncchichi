# 🧠 Moncchichi BLE Hub
Total Progress: 🟩 ~100 % complete 🔺 (auto-updated 2025-10-19 16:04 SGT)
...
- 2025-10-19 16:04 SGT — PR #92: **Add parser for G1 notify frames and log management controls** · delta `+2%` · tag `fix`
